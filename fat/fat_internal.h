...
/* Minimalne libc-like pomocne funkcie a utility pre textovy vystup. */
...
/* Pomocne funkcie pre parsovanie cesty a porovnavanie mien. */
int str_eq(const char *a, const char *b);
int parse_path_component(const char **path, char *component, unsigned int max_len);

/* Zakladne primitivy pre sektorovy pristup a FAT operacie. */
...
/* Pomocne funkcie pre vyhladavanie a navigaciu v adresaroch. */
...
/* Uvolni vsetky clustre naviazane od pociatocneho clustra. */
