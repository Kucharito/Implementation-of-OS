...
/* Prevedie meno suboru na uppercase FAT 8.3 polia s pevnou sirkou. */
...
/* Najde existujucu polozku suboru alebo prvy znovupouzitelny slot v adresari. */
...
/* Prehlada FAT a najde prvy volny datovy cluster (hodnota 0x0000). */
...
/* Uvolni cely FAT retazec clusterov spat do volneho stavu. */
...
/* Vytvori a zapise subor zo stdin dat do novo alokovanych clusterov. */
int write(char *filename)
{
    ...
    while (1)
    {
        ...
        if (read_bytes == 0)
          ...
          /* Alokuje/prelinkuje dalsi cluster, ked je aktualny plny alebo chyba. */
    ...
    /* Dokonci adresarovu polozku metadatami a ukazovatelom na prvy cluster. */
...
/* Zmaze subor uvolnenim retazca a oznacenim dir polozky ako zmazanej. */
